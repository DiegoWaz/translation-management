...
export const frFR: UiMessages = {
  ...
  "import": {
    ...
    "subtitle": "Choisissez le format, collez vos données, puis assignez chaque valeur à une clé.",
    "formatText": "Texte libre",
    "formatTable": "Excel / Tableau",
    "formatJson": "JSON",
    "hintText": "EN\n\nBonjour !\n\nCTA\n\nFR\n\n…",
    "hintTable": "fr-FR\tTitre\tSous-titre\nde-DE\tTitel\tUntertitel",
    "hintJson": "{\"en\":{\"clé\":\"val\"},\"fr\":{\"clé\":\"val\"}}",
    "placeholderText": "EN\n\nHello {name}!\n\n10% off\n\nFR\n\nBonjour {name} !\n\n10% de réduction",
    "placeholderTable": "fr-FR\tLes Marques de A à Z\tPlus de 200 marques de beauté, soin et parfum\nde-DE\tMarken von A bis Z\tÜber 150 Marken aus Beauty, Pflege und Parfüm\nes-ES\tMarcas de la A a la Z\tMás de 150 marcas de belleza, tratamiento y perfumes",
    "placeholderJson": "{\n  \"en\": { \"clé\": \"valeur\" },\n  \"fr\": { \"clé\": \"valeur\" }\n}",
    ...
    "createKeyAction": "Créer cette clé",
