...
export const enUK: UiMessages = {
  ...
  "import": {
    "title": "Bulk import",
    "subtitle": "Choose a format, paste your data, then assign each value to a key.",
    "formatText": "Free text",
    "formatTable": "Excel / Table",
    "formatJson": "JSON",
    "hintText": "EN\n\nHello!\n\nCTA\n\nFR\n\n…",
    "hintTable": "fr-FR\tTitle\tSubtitle\nde-DE\tTitel\tUntertitel",
    ...
    "emptyArrow": "⬅",
    "assignmentSummary": "{locales} locale{localesSuffix} · {columns} value{columnsSuffix} — assign each value to a key",
    "column": "Default value {index}",
    "targetKey": "Target key",
    "choose": "— choose —",
    "searchKey": "Search for a key…",
    "noMatchingKeys": "No matching keys",
    "createKeyFromSearch": "Create \"{key}\"",
    "createKeyAction": "Create this key",
