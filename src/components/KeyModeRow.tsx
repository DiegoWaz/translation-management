...
export const KeyModeRow = ({ rowKey, translations, original, configFiles, baseLang, isEven, isMobile, onUpdate, onDelete, onRename, onShowKeyHistory, onExportKey, onDuplicateKey, searchQuery }: {
  ...
  return (
    ...
    >
      {copying && (onDuplicateKey || onExportKey) ? (
        <div className={cn('flex items-center min-w-0 w-full', isMobile ? 'px-3 py-2.5' : 'px-5 py-3')}>
          <KeyCopyBar
            sourceKey={rowKey}
            value={copyDraft}
        ...
        <div className="flex items-center">
          ...
          {hovered && (onDuplicateKey || onExportKey) && !confirmingDelete && (
            <button
              onClick={startCopy}
